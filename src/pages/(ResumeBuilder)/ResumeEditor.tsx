            ...
            <div className="px-4 pt-3 md:px-6">
              <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2">
                ...
                <p className="text-xs leading-relaxed text-amber-800">
                  ...
                  stay safe. Fill all the profile data to ensure consistent and smooth resume generation. Adjust spacing for content section by adding or removing content and verifying the resume layout in Preview.
                </p>
              </div>
            </div>
